...
module.exports = class EventController {
  ...
  async create(data, uid) {
    try {
      ...
      if (!_season) {
        throw new NotFoundError('sesons cannot be found for that id');
      }

      if (!Object.keys(_season.activities).includes(activity)) {
        throw new InvalidDataError(
          'that activity is not valid for this season'
        );
      }
